...
// Mappings for mlkem-native
#define mlk_shake128ctx shake128incctx
#define mlk_shake128_init shake128_inc_init
#define mlk_shake128_absorb_once shake128_inc_absorb
#define mlk_shake128_squeezeblocks(BUF, NBLOCKS, CTX) shake128_inc_squeeze(BUF, (NBLOCKS)*SHAKE128_RATE, CTX)
